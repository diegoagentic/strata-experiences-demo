                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-destructive/15 text-destructive">
                                                                    ...
                                                                    <div key={d.globalIdx} className={`transition-all ${fix ? 'bg-success/10/30 dark:bg-success/100/5' : ''}`}>
                                                                        ...
                                                                        <div className="px-4 pb-2 grid grid-cols-2 gap-3">
                                                                            ...
                                                                            <div className="bg-muted/40 rounded-lg px-3 py-2">
                                                                                ...
                                                                                <div className={`text-sm font-medium ${d.field.status === 'mismatch' ? 'text-destructive' : 'text-warning'}`}>{d.field.ackValue}</div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                {!fix && (
                                                                                    <div className="flex gap-2 mt-2">
                                                                                        <button
                                                                                            ...
                                                                                            className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold bg-success/100 hover:bg-success text-white rounded-lg transition-colors"
                                                                                        >
