...
export default function Workspace({ onBack, onLogout, onNavigateToWorkspace, onNavigate }: WorkspaceProps) {
    ...
    return (
        <div className="h-screen bg-gray-50 dark:bg-black font-sans text-foreground flex flex-col overflow-hidden relative">
                            ...
                            {systemLogs.map((log) => (
                                <div key={log.id} className="flex items-start gap-3 text-sm p-2 rounded hover:bg-accent">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-foreground dark:text-gray-200 font-mono text-xs">{log.text}</p>
                ...
                <div className="flex items-center justify-between px-6 py-3 bg-background/80 backdrop-blur-xl border-b border-border z-10">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-xs font-medium text-muted-foreground hidden lg:inline mr-2">Frequent Actions:</span>
                            <div className="flex items-center gap-1">
                                ...
                                >
                                    ...
                                    <span className="text-[10px] font-medium text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900 transition-colors">Analyze</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span className="text-[10px] font-medium text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900 transition-colors">Summarize</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span className="text-[10px] font-medium text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900 transition-colors">Inventory</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            >
                                ...
                                <span className="text-[10px] font-medium text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900 transition-colors">Logs</span>
                            </button>
                            <button
                            ...
                            >
                                <div className={`transition-colors ${showActivity ? 'text-zinc-900 dark:text-primary' : 'text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900'}`}>
                                    <ClockIcon className="w-4 h-4" />
                                </div>
                                <span className={`text-[10px] font-medium transition-colors ${showActivity ? 'text-zinc-900 dark:text-primary' : 'text-muted-foreground group-hover:text-zinc-900 dark:group-hover:text-zinc-900'}`}>Activity</span>
                            </button>
                        </div>
                    </div>
                </div>
                            ...
                            {appActivities.map((activity, i) => {
                                ...
                                return (
                                    <div key={activity.id} className="relative pl-0 pb-2 border-b border-border/50 last:border-0 hover:bg-accent p-3 rounded transition-colors group">
                                        ...
                                        <p className="text-sm font-medium leading-tight text-foreground dark:text-gray-200">{activity.text}</p>
                                ...
                                <div className="relative flex items-center gap-2 bg-card p-2 pr-2 rounded-full border border-border shadow-sm transition-all focus-within:ring-2 ring-primary/20 focus-within:border-primary">
                                    ...
                                    <button
                                        ...
                                        className={`p-2 rounded-full transition-all duration-200 ${inputValue.trim()
                                            ...
                                            : 'bg-gray-100 dark:bg-white/10 text-muted-foreground scale-95'
                                            }`}
                                    >
