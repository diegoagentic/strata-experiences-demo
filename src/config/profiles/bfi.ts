...
//
// DEMO STRUCTURE: 1 flow · 13 steps in 3 sidebar groups (post-Sales Coordinator revisions May 2026)
//
...
//     a1.1:   Ingestion                — Claims Analyst opens · DOE-2847 surfaced
//     a1.2:   Confirm receipt          — Claims Analyst replies · Miller Knoll acknowledges
...
//                                        3) email WIG for labor · Approver compiles
//     a1.2b3: Send proposal            — Claims Analyst emails NYC DOE the full proposal
//     a1.2c:  PO received              — Claims Analyst confirms the PO in CORE
//
//   GROUP 2 · Receiving & Resolution (a1.2d → a1.2f · 3 steps)
//     a1.2d:  Bingo check              — Strata scans WIG report · finds missing carton
//     a1.2e:  File shortage claim      — Claims Analyst files claim with Herman Miller (preserves the email dialog)
//     a1.2f:  Notify scheduler         — Replacement confirmed · Operations Manager notified (preserves the email dialog)
//
//   GROUP 3 · CPR & Closing (a1.3 → a1.4 · 4 steps)
//     a1.3:   CPR review               — Field hours vs quote · Claims Analyst approves (preserves CPR notify dialog)
//     a1.3b:  Manager approval         — Approver sends invoice request to Receiving Coordinator (preserves Receiving Coordinator email)
//     a1.3c:  Invoice forward          — Claims Analyst forwards approved invoice to Estimator/Finance (preserves Estimator email)
//     a1.4:   Fee verification         — Estimator compares Receiving Coordinator's fee vs contract (Strata catches gap)
//
...
export const BFI_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        groupTitle: 'Flow 1: Pre-award',
        title: 'Ingestion',
        description: 'Claims Analyst opens her ingestion queue. Strata ranks active CoNY orders by urgency and surfaces DOE-2847 at the top — ready for review.',
        app: 'bfi-agency-fee',
    ...
    },
    {
        ...
        description: 'Robert acknowledges the order — quote Q-2026-0089 is locked in. Claims Analyst moves on to validate pricing.',
        app: 'bfi-agency-fee',
        role: 'Designer',
    },
    {
    ...
    },
    {
        ...
        groupTitle: 'Flow 1: Pre-award',
        title: 'Send proposal',
        description: 'Product pricing and labor are both ready. Claims Analyst reviews the full proposal and sends it to NYC DOE procurement.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
        ...
        groupTitle: 'Flow 1: Pre-award',
        title: 'PO received',
        description: 'The Purchase Order comes back from NYC DOE. Claims Analyst checks it against the proposal and locks in the 30-day delivery window in CORE.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    ...
    // Kept as 3 steps to preserve the dialogs (claim email to HM, Operations Manager notify).
    // ═══════════════════════════════════════════
    {
        id: 'a1.2d',
        groupId: 2,
    ...
    },
    {
        ...
        description: 'AP Coordinator flags a missing carton. Claims Analyst reviews the order, attaches the receiving report as proof, and files the claim with Herman Miller.',
        app: 'bfi-receiving',
        role: 'Account Manager',
    },
    {
        ...
        description: 'Herman Miller confirms the replacement shipment. Claims Analyst reviews the updated work order and notifies Operations Manager (project manager) to schedule the install crew.',
        app: 'bfi-receiving',
        role: 'Account Manager',
    },
    ...
    // Kept as 4 steps to preserve the dialogs (CPR notify, Receiving Coordinator email, Estimator forward).
    // ═══════════════════════════════════════════
    {
        id: 'a1.3',
        groupId: 3,
        ...
        title: 'CPR review',
        description: 'Labor hours from the field don\'t match the original quote. Claims Analyst reviews the gaps — Strata prepared the revision automatically — approves line by line, and notifies the team.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
        ...
        description: 'Approver reviews Claims Analyst\'s CPR approval and the final labor numbers, then sends the invoice request to Receiving Coordinator at Herman Miller.',
        app: 'bfi-agency-fee',
        role: 'BFI Manager',
    },
    {
        ...
        description: 'The invoice arrives. Claims Analyst attaches it to the record — Strata identifies the document automatically — and forwards it to Finance/AR to close out the order.',
        app: 'bfi-agency-fee',
        role: 'Account Manager',
    },
    {
        ...
        description: 'Estimator compares Receiving Coordinator\'s reported fee against the per-line GP already booked in CORE (per Contract ANT122). Each product is matched line by line — Strata catches a −$255.24 gap on HMI-LS-500 automatically. Estimator decides whether to confirm the match or flag the discrepancy.',
        app: 'bfi-agency-fee',
        role: 'Finance / AR',
    },
...
export const BFI_STEP_BEHAVIOR: Record<string, StepBehavior> = {
    'a1.0': { mode: 'interactive', userAction: 'Watch Account Manager Bly send the request to Claims Analyst · specs, floor plan and pricing file arrive in Strata' },
    ...
    'a1.2e': { mode: 'interactive', userAction: 'Open AP Coordinator\'s missing-carton alert · expand the order · send the claim to Herman Miller' },
    'a1.2f': { mode: 'interactive', userAction: 'Open the claim-resolved notification · review the work order + floor plan · notify Operations Manager to schedule the crew' },
    ...
    'a1.3b': { mode: 'interactive', userAction: 'Review Claims Analyst\'s CPR approval · send the invoice request to Receiving Coordinator at Herman Miller' },
    'a1.3c': { mode: 'interactive', userAction: 'Upload the approved invoice · Strata detects it automatically · forward to Estimator in Finance/AR' },
    'a1.4': { mode: 'interactive', userAction: 'Compare per-line: each product expected vs received from Receiving Coordinator · 2 lines match · 1 line gap (HMI-LS-500 · −$255.24) · confirm or flag' },
};
...
export const BFI_STEP_MESSAGES: Record<string, string[]> = {
    'a1.0': [
        ...
        'Documents in intake · alerting Claims Analyst',
    ],
    'a1.1': [
    ...
    'a1.2b': [
        ...
        'WIG response in · forwarded to Approver',
        'Approver compiled labor · Teamsters 24h · Carpenters 50h · OT 8h · Inside 4h',
    ...
    'a1.3b': [
        'CPR approval received from Claims Analyst',
        'Final labor · Teamsters 24h · Carpenters 45h · OT 6h',
        'New total $6,920 (−$720 from quote)',
        'Drafting invoice request to Receiving Coordinator',
    ],
    'a1.3c': [
    ...
    'a1.4': [
        ...
        'Pulling Receiving Coordinator\'s report from Herman Miller',
