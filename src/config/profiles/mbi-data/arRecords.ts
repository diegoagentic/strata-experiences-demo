...
export const MBI_AR_RECORDS: ARRecord[] = [
    { id: 'AR-001', client: 'Enterprise Holdings', poNumber: 'PO-2025-0892', amount: 42500, daysPastDue: 12, status: 'pending-approval', salesperson: 'Sales Rep Ash', collectionsHold: true, holdReason: 'installation-pending', installationDate: '2026-05-15' },
    { id: 'AR-002', client: 'Commerce Bank', poNumber: 'PO-2025-0901', amount: 18200, daysPastDue: 18, status: 'no-response', lastContact: '2026-04-10', salesperson: 'Designer Wren', replyIntent: 'Client replied Apr 27 · "contact us after Apr 29" · follow-up scheduled' },
    { id: 'AR-003', client: 'Lakeside Health', poNumber: 'PO-2025-0915', amount: 88400, daysPastDue: 5, status: 'committed-to-pay', lastContact: '2026-04-18', salesperson: 'Designer Quinn' },
    ...
    { id: 'AR-011', client: 'SSM Health', poNumber: 'PO-2025-0987', amount: 67200, daysPastDue: 17, status: 'pending-approval', salesperson: 'Designer Quinn' },
    { id: 'AR-012', client: 'Anheuser-Busch', poNumber: 'PO-2025-0991', amount: 124800, daysPastDue: 2, status: 'committed-to-pay', salesperson: 'Sales Lead' },
];
